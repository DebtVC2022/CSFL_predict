# 完整版：扩展类别不平衡方法 + 校准对比 + SHAP + LIME 可解释性分析
import numpy as np
import joblib
import pandas as pd
...
plt.savefig("./lgb_img/revisions/roc_curve_1_revisions_SMOTE.png")
plt.show()
...
plt.legend(); plt.tight_layout()
plt.savefig("./lgb_img/revisions/calibration_compare_1_revisions_SMOTE.png")
plt.show()
...
plt.tight_layout()
plt.savefig("./lgb_img/revisions/lgb_shap_summary_1_revisions_SMOTE.png")
plt.close()
...
fig.tight_layout()
fig.savefig("./lgb_img/revisions/lgb_lime_explanation_0_1_revisions_SMOTE.png")
...
plt.tight_layout()
plt.savefig("./lgb_img/revisions/lgb_feature_importance_1_revisions_SMOTE.png")
plt.show()
...
# ========== 保存模型 ==========
joblib.dump(best_model, "./model_best/best_model_lgb_1_revisions_SMOTE.pkl")
print("模型已保存")
