...
# 贝叶斯搜索参数空间
param_space = {
    'n_estimators': [2, 5, 10, 20, 25, 30, 35, 40, 50],
    'learning_rate': [0.001, 0.01, 0.05, 0.1],
    'max_depth': [2, 3, 4, 5, 6, 7, -1],
...
plt.tight_layout()
plt.savefig("./lgb_img/lgb_auc_curve.png")
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("./lgb_img/lgb_calibration_curve.png")
plt.show()
...
plt.tight_layout()
plt.savefig("./lgb_img/lgb_feature_importance.png")
plt.show()

# 保存最优模型
best_model_file = "./model_best/best_model_lgb.pkl"
